...
var layers_de = {
  ...
  // Create the map with our layers_de
  var map_de = L.map("map-de", {
    center: [43, -76.0059],
    zoom: 7,
    layers: [
      layers_de.Arson,
      layers_de.Campfire,
      layers_de.Children,
      layers_de.Debris_Burning,
      layers_de.Equipment_Use,
      layers_de.Fireworks,
      layers_de.Lightning,
      layers_de.Miscellaneous,
      layers_de.Missing_Undefined,
      layers_de.Powerline,
      layers_de.Railroad,
      layers_de.Smoking,
      layers_de.Structure,
  ...
  lightmap.addTo(map_de);
  
  // Create an overlays object to add to the layer control
  var overlays_de = {
    "Arson": layers_de.Arson,
    "Campfire": layers_de.Campfire,
    "Children": layers_de.Children,
    "Debris Burning": layers_de.Debris_Burning,
    "Equipment Use": layers_de.Equipment_Use,
    "Fireworks": layers_de.Fireworks,
    "Lightning": layers_de.Lightning,
    "Miscellaneous": layers_de.Miscellaneous,
    "Missing/Undefined": layers_de.Missing_Undefined,
    "Powerline": layers_de.Powerline,
    "Railroad": layers_de.Railroad,
    "Smoking": layers_de.Smoking,
    "Structure": layers_de.Structure,
    "Other": layers_de.Other
  };

  // Create a control for our layers_de, add our overlay layers_de to it
  L.control.layers(null, overlays_de).addTo(map_de);
  ...
  info.onAdd = function() {
    var div = L.DomUtil.create("div", "legend_de");
    return div;
  };
  ...
  d3.json("http://127.0.0.1:5000/api/fire_log_de", function(fireLog) {
      ...
      // Initialize a stationStatusCode, which will be used as a key to access the appropriate layers_de, icons, and station count for layer group
      var firetypeCode;
      ...
      for (var i = 0; i < fireLog.length; i++) {
        ...
        newMarker.addTo(layers_de[firetypeCode]);
      ...
      updateLegend_de(fireCount);
    });

  
  // Update the legend's innerHTML with the last updated time and station count
  function updateLegend_de(fireCount) {
    document.querySelector(".legend_de").innerHTML = [
