...
var layers_md = {
  ...
  // Create the map with our layers_md
  var map_md = L.map("map-md", {
    center: [39, -76.6413],
    zoom: 8,
    layers: [
      layers_md.Arson,
      layers_md.Campfire,
      layers_md.Children,
      layers_md.Debris_Burning,
      layers_md.Equipment_Use,
      layers_md.Fireworks,
      layers_md.Lightning,
      layers_md.Miscellaneous,
      layers_md.Missing_Undefined,
      layers_md.Powerline,
      layers_md.Railroad,
      layers_md.Smoking,
      layers_md.Structure,
  ...
  lightmap.addTo(map_md);
  
  // Create an overlays object to add to the layer control
  var overlays_md = {
    "Arson": layers_md.Arson,
    "Campfire": layers_md.Campfire,
    "Children": layers_md.Children,
    "Debris Burning": layers_md.Debris_Burning,
    "Equipment Use": layers_md.Equipment_Use,
    "Fireworks": layers_md.Fireworks,
    "Lightning": layers_md.Lightning,
    "Miscellaneous": layers_md.Miscellaneous,
    "Missing/Undefined": layers_md.Missing_Undefined,
    "Powerline": layers_md.Powerline,
    "Railroad": layers_md.Railroad,
    "Smoking": layers_md.Smoking,
    "Structure": layers_md.Structure,
    "Other": layers_md.Other
  };

  // Create a control for our layers_md, add our overlay layers_md to it
  L.control.layers(null, overlays_md).addTo(map_md);
  ...
  info.onAdd = function() {
    var div = L.DomUtil.create("div", "legend_md");
    return div;
  };
  ...
  d3.json("http://127.0.0.1:5000/api/fire_log_md", function(fireLog) {
      ...
      // Initialize a stationStatusCode, which will be used as a key to access the appropriate layers_md, icons, and station count for layer group
      var firetypeCode;
      ...
      for (var i = 0; i < fireLog.length; i++) {
        ...
        newMarker.addTo(layers_md[firetypeCode]);
      ...
      updateLegend_md(fireCount);
    });

  
  // Update the legend's innerHTML with the last updated time and station count
  function updateLegend_md(fireCount) {
    document.querySelector(".legend_md").innerHTML = [
